...
export default function ColorsCustomization() {
      ...
      <main className="flex-1 flex flex-col">
        ...
        <header className="h-14 bg-gradient-to-r from-[#0f3b37] to-[#1f4f49] flex items-center justify-between px-6 text-white">
          <div className="flex items-center gap-3 text-sm">
            ...
            <span className="text-white">Colors Customization</span>
          </div>
        ...
        <div className="bg-gray-50 border-b px-6 py-4">
          <h1 className="text-xl font-semibold">Colors Customization</h1>
        ...
        <div className="px-6 pt-4">
          <div className="flex gap-6 border-b">
            {["Primary", "Action Button", "Quick Menu"].map((tab, i) => (
              <button
                key={i}
          ...
          <div className="bg-white rounded-xl shadow p-6 space-y-6">
            {items.map(({ key, label }) => (
              <div key={key} className="flex items-center gap-6">
                ...
                <div className="flex-1 h-8 rounded-lg bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 opacity-30" />
