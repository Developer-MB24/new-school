...
export default function BlogManagement() {
  const blogs = [
    ...
    {
      title: "Benefits of Music Education for Children",
      date: "Apr 19, 2024",
      status: "Published",
    },
    {
      title: "Outdoor Play Ideas for Kids",
      date: "Apr 18, 2024",
      status: "Published",
    },
  ];
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="bg-gray-50 border-b px-6 py-4 flex justify-between items-center">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-md text-sm hover:bg-green-700">
            <FaPlus className="text-xs" /> Add New Post
          </button>
        </div>
        ...
        <div className="px-6 pt-4">
          <div className="flex gap-6 border-b">
            {["Posts", "Options", "Section Bar"].map((tab, i) => (
              <button
                key={i}
              ...
              <tbody className="divide-y">
                {blogs.map((blog, i) => (
                  <tr key={i} className="hover:bg-gray-50">
                    ...
                    <td className="px-5 py-3">{blog.date}</td>
